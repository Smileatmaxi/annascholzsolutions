            ...
            <section className="min-h-screen flex flex-col justify-center space-y-12 px-6 md:px-12 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-4 text-center">
                        <h1 className="mb-16 text-3xl font-extrabold tracking-widest md:text-3xl lg:text-3xl">UNDERWATER MOVIE SHOT IN THE MALEDIVES</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-4 text-center">
                        <h1 className="mb-16 text-3xl font-extrabold tracking-widest md:text-3xl lg:text-3xl">SHORT UNDERWATER MOVIE</h1>
                        <p className="text-m tracking-wide uppercase">
                        </p>
                    </div>
                </div>
